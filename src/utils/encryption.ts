...
export async function compareHash(inputPassword: string, userPassword: string): Promise<boolean> {
...
export function decryptPassword(encryptedPassword: string, secret: string): string {
